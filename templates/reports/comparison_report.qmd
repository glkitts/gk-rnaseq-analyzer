...
# Only show interactive plot for HTML output
if (knitr::is_html_output()) {
  ...
  cat("*Interactive plot available in HTML version only*")
}
```
  ...
  if (nrow(sig_pathways) > 0) {
    ...
    p <- ggplot(sig_pathways, aes(
      ...
      theme(
        ...
        legend.box = "vertical",
        legend.title = element_markdown(size = rel(0.9)),
